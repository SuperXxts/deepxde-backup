...
RESP_LONG="--geometry_stage_iterations 800 --material_stage_iterations 400"
...
launch_one 10.6.234.22 0 rs0_stagephys_only_smoke2k ""
launch_one 10.6.234.23 0 rs1_split_freeze_smoke2k "${RESP_FREEZE}"
launch_one 10.6.234.24 0 rs2_split_bin_smoke2k "${RESP_FREEZE} ${RESP_BIN}"
launch_one 10.6.234.25 0 rs3_split_bin_contrast_smoke2k "${RESP_FREEZE} ${RESP_BIN} ${RESP_CONTRAST}"
launch_one 10.6.234.27 0 rs4_split_bin_contrast_lock4_smoke2k "${RESP_FREEZE} ${RESP_BIN} ${RESP_CONTRAST} ${RESP_LOCK4}"
launch_one 10.6.234.28 0 rs5_split_bin_contrast_lock8_smoke2k "${RESP_FREEZE} ${RESP_BIN} ${RESP_CONTRAST} ${RESP_LOCK8}"
launch_one 10.6.234.29 0 rs6_split_bin_contrast_lock8_longgeom_smoke2k "${RESP_FREEZE} ${RESP_BIN} ${RESP_CONTRAST} ${RESP_LOCK8} ${RESP_LONG}"
launch_one 10.6.234.30 0 rs7_split_bin_contrast_lock8_sharp_smoke2k "${RESP_FREEZE} ${RESP_BIN} ${RESP_CONTRAST} ${RESP_LOCK8} ${RESP_SHARP}"
